// ---------------------------------------------------------------------------
// web-vitals.test.ts — unit tests for registerWebVitals() (client SPA)
...
// D-4: client-only implementation — independent of backoffice SPA.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Static import AFTER mocks are declared (vi.mock() hoisting ensures order).
// ---------------------------------------------------------------------------
...
// (Direct call count is not assertable after clearAllMocks resets module-init calls.)
// ---------------------------------------------------------------------------
describe("web-vitals — vitalsHistogram is initialized", () => {
  it("histogram.record spy is a function (module-level init ran)", () => {
    // The fact that mockRecord is a function accessible from the module means
    // getMeter().createHistogram() was called during module evaluation.
...
// ---------------------------------------------------------------------------
describe("registerWebVitals — subscriptions", () => {
...
// ---------------------------------------------------------------------------
describe("registerWebVitals — report callback invokes histogram.record", () => {
