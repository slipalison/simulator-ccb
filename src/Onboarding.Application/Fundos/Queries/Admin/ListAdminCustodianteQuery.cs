...
/// <summary>
/// Cross-company admin query for paginated Custodiante listing (D-8).
...
/// </summary>
public sealed record ListAdminCustodianteQuery(
    int Page = 1,
    int PageSize = 20,
    string? Search = null,
    Guid? CompanyId = null) : IQuery<PaginatedResult<AdminCustodianteDto>>;
