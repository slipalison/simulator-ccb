...
/// <summary>
/// Cross-company admin query for paginated FundoCedente listing (D-8).
...
/// </summary>
public sealed record ListAdminFundoCedenteQuery(
    int Page = 1,
    int PageSize = 20,
    Guid? CompanyId = null) : IQuery<PaginatedResult<AdminRelFundoCedenteDto>>;
