...
/// <summary>
/// Cross-company admin query for paginated ConsultoriaFundo listing (D-8).
...
/// </summary>
public sealed record ListAdminConsultoriaQuery(
    int Page = 1,
    int PageSize = 20,
    string? Search = null,
    Guid? CompanyId = null) : IQuery<PaginatedResult<AdminConsultoriaFundoDto>>;
