...
public class UpdateCustodianteCommandHandlerTests
{
    ...
    public UpdateCustodianteCommandHandlerTests()
    {
        ...
        _sut = new UpdateCustodianteCommandHandler(_repository, _auditService, _logger);
    }
    ...
    {
        // Arrange
        var custodiante = Custodiante.Register("Nome Original", "11444777000161", Guid.NewGuid(), "CUST-001");
