...
/// <summary>
/// FluentValidation for RegisterConsultoriaFundoCommand (CAD-01, T-47-01).
/// CNPJ validated via Cnpj.Create() — catches invalid check digits and format.
/// </summary>
public sealed class RegisterConsultoriaFundoCommandValidator
    : AbstractValidator<RegisterConsultoriaFundoCommand>
{
    public RegisterConsultoriaFundoCommandValidator()
    {
