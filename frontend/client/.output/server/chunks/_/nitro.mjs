...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"D:\\REPO\\keycloak-tests\\frontend\\client","order":0,"outDir":"D:/REPO/keycloak-tests/frontend/client/.vinxi/build/public"},{"name":"api-proxy","type":"http","handler":"server.ts","target":"server","base":"/api","root":"D:\\REPO\\keycloak-tests\\frontend\\client","outDir":"D:/REPO/keycloak-tests/frontend/client/.vinxi/build/api-proxy","order":1},{"name":"client","type":"spa","handler":"index.html","vite":{"server":{"host":"0.0.0.0","port":5173,"hmr":{"host":"localhost","port":5173,"clientPort":5173},"watch":{"usePolling":true,"interval":1000}}},"base":"/","root":"D:\\REPO\\keycloak-tests\\frontend\\client","target":"browser","outDir":"D:/REPO/keycloak-tests/frontend/client/.vinxi/build/client","order":2}],"server":{},"root":"D:\\REPO\\keycloak-tests\\frontend\\client"};
					const buildManifest = {"api-proxy":{"virtual:$vinxi/handler/api-proxy":{"file":"api-proxy.js","name":"api-proxy","src":"virtual:$vinxi/handler/api-proxy","isEntry":true}},"client":{"index.html":{"file":"assets/index-mascaoFd.js","name":"index","src":"index.html","isEntry":true,"css":["assets/index-BM4pZ_Vq.css"]}}};
...
const assets = {
  "/index.html": {
    ...
    "etag": "\"1f4-i+53ywv+A6CGPdtNowPF85ipc5A\"",
    "mtime": "2026-04-09T23:25:06.476Z",
    "size": 500,
  ...
  "/manifest.js": {
    ...
    "mtime": "2026-04-09T23:25:06.475Z",
    "size": 20,
    "path": "../public/manifest.js"
  },
  "/.vite/manifest.json": {
    "type": "application/json",
    "etag": "\"b9-5WR70Y1B2cWuwVa96Can/A+J9MA\"",
    "mtime": "2026-04-09T23:25:06.477Z",
    "size": 185,
    "path": "../public/.vite/manifest.json"
  },
  "/assets/index-BM4pZ_Vq.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"985a-lhaayHrQXsGlaX38vuyilLk7Ypk\"",
    "mtime": "2026-04-09T23:25:06.477Z",
    "size": 39002,
    "path": "../public/assets/index-BM4pZ_Vq.css"
  },
  "/assets/index-mascaoFd.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"89fad-G7cQKFHjgVK7CVELnCBhpYl+Hqg\"",
    "mtime": "2026-04-09T23:25:06.477Z",
    "size": 565165,
    "path": "../public/assets/index-mascaoFd.js"
  }
};
...
const _6URh1w = eventHandler((event) => {
...
const y = "http://api:8080", k = defineEventHandler(async (o) => {
  var _a, _b;
  const n = (_a = o.node.req.method) != null ? _a : "GET", d = (_b = o.path) != null ? _b : "/", f = `${y}/api${d}`, a = !["GET", "HEAD", "OPTIONS"].includes(n), h = getHeaders(o), r = {};
  for (const [e, t] of Object.entries(h)) e.toLowerCase() !== "host" && e.toLowerCase() !== "content-length" && typeof t == "string" && (r[e] = t);
  const i = { method: n, headers: r, duplex: a ? "half" : void 0 };
  a && (i.body = await readRawBody(o, false));
  const s = await fetch(f, i), c = s.headers.get("set-cookie");
  if (c) {
    const e = c.split(/,(?=\s*\w+=)/);
    for (const t of e) o.node.res.appendHeader("Set-Cookie", t);
  }
  for (const [e, t] of s.headers.entries()) e.toLowerCase() !== "set-cookie" && e.toLowerCase() !== "content-length" && e.toLowerCase() !== "transfer-encoding" && o.node.res.setHeader(e, t);
  o.node.res.statusCode = s.status;
  const u = await s.arrayBuffer();
  return Buffer.from(u);
});

const html = "<!DOCTYPE html>\n<html lang=\"pt-BR\" data-color-mode=\"light\" suppressHydrationWarning>\n  <head>\n    <meta charset=\"UTF-8\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n    <title>Onboarding — Cliente</title>\n    <script type=\"module\" crossorigin src=\"/assets/index-mascaoFd.js\"></script>\n    <link rel=\"stylesheet\" crossorigin href=\"/assets/index-BM4pZ_Vq.css\">\n    <script src=\"/manifest.js\"></script>\n  </head>\n  <body>\n    <div id=\"root\"></div>\n  </body>\n</html>\n";
							const _NExIIH = eventHandler$1(event => {
								return html
							});

const handlers = [
  { route: '', handler: _6URh1w, lazy: false, middleware: true, method: undefined },
  { route: '/api', handler: k, lazy: false, middleware: true, method: undefined },
